...
import dev.matthiesen.cobblemon_skills.common.interfaces.Profession;
import dev.matthiesen.cobblemon_skills.common.interfaces.ProfessionProgress;
...
public final class ProfessionManager {
    ...
    public void onServerTick(ServerEvent.EndTick event) {
