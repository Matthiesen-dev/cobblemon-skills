...
public final class PermissionsConfig {
    ...
    public PermissionsConfig(ModConfigSpec.Builder builder) {
        ...
        command_cobbleskills_reset_player = builder
                ...
                .defineEnum("cobbleskills_reset_player", PermissionLevel.MULTIPLAYER_MANAGEMENT);
        command_cobbleskills_reset_all = builder
                .comment("The permission level required to use the /cobbleskills reset all command.")
                .defineEnum("cobbleskills_reset_all", PermissionLevel.ALL_COMMANDS);
        ...
        command_cobbleskills_admin_addExp = builder
                ...
                .defineEnum("cobbleskills_admin_add_exp", PermissionLevel.ALL_COMMANDS);
        command_cobbleskills_admin_setLevel = builder
                ...
                .defineEnum("cobbleskills_admin_set_level", PermissionLevel.ALL_COMMANDS);
        command_cobbleskills_admin_reload = builder
                .comment("The permission level required to use the /cobbleskills admin reload command.")
                .defineEnum("cobbleskills_admin_reload", PermissionLevel.ALL_COMMANDS);
